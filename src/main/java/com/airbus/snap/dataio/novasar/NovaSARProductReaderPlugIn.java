...
/**
 * The ReaderPlugIn for NovaSAR products.
 */
public class NovaSARProductReaderPlugIn implements ProductReaderPlugIn {
    ...
    public DecodeQualification getDecodeQualification(final Object input) {
        ...
        if (file != null) {
            ...
            if (filename.endsWith(".ZIP") && filename.startsWith(NovaSARConstants.MISSION_NAME) &&
                    ZipUtils.findInZip(file, "", NovaSARConstants.PRODUCT_HEADER_NAME)) {
                return DecodeQualification.INTENDED;
            }
        }
        //todo zip stream
    ...
    public Class[] getInputTypes() {
        return NovaSARConstants.VALID_INPUT_TYPES;
    }
    ...
    public ProductReader createReaderInstance() {
        return new NovaSARProductReader(this);
    }
    ...
    public String[] getFormatNames() {
        return NovaSARConstants.getFormatNames();
    }
    ...
    public String[] getDefaultFileExtensions() {
        return NovaSARConstants.getFormatFileExtensions();
    }
    ...
    public String getDescription(final Locale locale) {
        return NovaSARConstants.getPluginDescription();
    }
    ...
    public static class FileFilter extends SnapFileFilter {
        ...
        FileFilter() {
            super();
            setFormatName(NovaSARConstants.getFormatNames()[0]);
            setExtensions(NovaSARConstants.getFormatFileExtensions());
            setDescription(NovaSARConstants.getPluginDescription());
        }
        ...
        public boolean accept(final File file) {
            if (super.accept(file)) {
                ...
                if (file.isDirectory() ||
                        (name.startsWith(NovaSARConstants.PRODUCT_HEADER_PREFIX) && name.endsWith(NovaSARConstants.getIndicationKey())) ||
                        (name.startsWith(NovaSARConstants.MISSION_NAME) && name.endsWith(".ZIP"))) {
                    return true;
                }
            }
            return false;
